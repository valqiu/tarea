...
namespace SailorMoon.Controllers
{
    public class CursoesController : Controller
    {
        ...
        public CursoesController(SailorMoonContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Curso != null ? 
                          ...
                          Problem("Entity set 'SailorMoonContext.Curso'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SailorMoonContext.Curso'  is null.");
            }
            var curso = await _context.Curso.FindAsync(id);
            if (curso != null)
            {
